...
namespace ModeloSql
{
    public class ManejaSQL
    {
        ...
        public SqlConnection AbrirConexion()
        {
            ...
            //	string cadena = System.Configuration.ConfigurationManager.ConnectionStrings["conexionConfig"].ConnectionString;
            string cadena=System.Configuration.ConfigurationManager.ConnectionStrings["conexionConfigu"].ConnectionString;
            try
            {
