<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="consultaalta.aspx.cs" Inherits="logginweb.consultaalta" %>
   ...
   <ul>
     ...
     <%-- <input id="direccion" name="direccion" value="" />
       --%> <%--<asp:DropDownList ID="Listascuatric" runat="server" Height="25px" Width="208px"></asp:DropDownList>--%>
                    <asp:DropDownList ID="Listascuatric" runat="server"></asp:DropDownList>
